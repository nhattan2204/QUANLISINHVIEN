	...
	public class XL_BANG: DataTable
	{
		...
		public void Doc_bang()
		{
			...
			try
			{
				...
				mBo_doc_ghi.RowUpdated += new SqlRowUpdatedEventHandler(mBo_doc_ghi_RowUpdate);
		...
		//Thực hiện câu truy vẫn cập nhật dữ liệu (Insert, Update, Delete)
		...
		public Object Thuc_hien_lenh_tinh_toan(String Lenh)
		{
			...
			//Xử lý sự kiện Rowupdate đối với trường khóa chính có kiểu Autonumber
			private void mBo_doc_ghi_RowUpdate(Object sender, SqlRowUpdatedEventArgs e)
			{
